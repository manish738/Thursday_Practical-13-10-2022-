...
public class RepeatedCharPr3 
{
    ...
    static void RepeatedNonRepeatedChar(String inputString)
    {
        ...
        char[] strArray = inputString.toCharArray();   //Converting inputString to char array
         
        //Checking each character of how many type occurrences store as a value
